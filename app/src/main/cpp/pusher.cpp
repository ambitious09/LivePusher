...
JNIEXPORT void JNICALL Java_com_jutong_live_jni_PusherNative_setVideoOptions(
...
JNIEXPORT jint JNICALL Java_com_jutong_live_jni_PusherNative_getInputSamples() {
...
JNIEXPORT void JNICALL Java_com_jutong_live_jni_PusherNative_stopPusher(
...
JNIEXPORT void JNICALL Java_com_jutong_live_jni_PusherNative_release(
        JNIEnv *env, jobject thiz) {
    Java_com_jutong_live_jni_PusherNative_stopPusher(env, thiz);
    if (audioEncHandle) {
